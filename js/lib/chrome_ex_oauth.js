 ...
 *             code, etc.
 *         passThru {Object} Additional static arguments, see opt_passThru.
 ...
 * @param {Object} opt_passThru Additional parameter to pass to the callback.
 */
ChromeExOAuth.prototype.sendSignedRequest = function(url, callback,
  ...
  ChromeExOAuth.sendRequest(method, signedUrl, headers, body, function (xhr) {
    if (xhr.readyState == 4) {
      callback(xhr.responseText, xhr, opt_passThru);
    }
  });
};
